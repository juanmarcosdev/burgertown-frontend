class ActionProvider {
    ...
    // new method
    info() {
        const greetingMessage = this.createChatBotMessage(`Si necesitas informacion sobre las sedes usa la palabra clave sedes, \n
                                                        Si necesitas informacion sobre como pedir usa la palabra clave pedido, \n
                                                        Si necesitas informacion sobre promociones usa la palabra clave descuento, \n
                                                        Si necesitas informacion sobre el producto del dia de hoy usa la palabra clave producto del dia, \n
                                                        Si necesitas informacion sobre como comprar usa la palabra clave comprar \n`);
        this.updateChatbotState(greetingMessage);
    }

    // new method
    greet2() {
        const greetingMessage = this.createChatBotMessage("Hola! Cómo estás? En qué puedo ayudarte?");
        this.updateChatbotState(greetingMessage);
    }
